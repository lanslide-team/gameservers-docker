...
ENV_VAR_ARR="SV_NAME SV_RCON_PASSWORD SV_PASSWORD SV_PUBLIC SV_MOTD SV_MAXPLAYERS SV_FRIENDLY_FIRE SV_MAPCYCLE_TIMEOUT SV_TK_BAN SV_TK_COOLDOWN SV_TK_GRACE SV_BAN_PENALTY SV_MAPVOTE SV_MAPCYCLE_TIMEOUT SV_MAPCYCLE_ADD ANTIHALOFP SV_TIMELIMIT"
SERVER_CFG=init.txt
GAME_FOLDER=/haloce
